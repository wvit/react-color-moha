...
var Block = exports.Block = function Block(_ref) {
  ...
  var handleChange = function handleChange(hexCode, e) {
    //hexCode在原代码中是一个字符串或对象，但作者好像当做都是字符串。对象的key需指定label，否则为undefined
    _color2.default.isValidHex(hexCode.undefined || hexCode) && onChange({
      hex: hexCode.undefined || hexCode,
      source: 'hex'
    }, e);
  };
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_common.EditableInput, {
        ...
        className: 'react-color-moha-input' //设置input class
      })
    )
  );
};
